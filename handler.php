<?php
    ...
    $regexp = "/^(\-|\+)?([0-9]+((\.|\,)[0-9]+)?)$/";
    if (!preg_match($regexp, $y)){
        echo '<script type="text/javascript">alert("Invalid argument. Введите значение Y от -3 до 3.")</script>';
        exit;
    }
    else{
...
//        echo '<script type="text/javascript">extendSize("answer")</script>';
        echo '    
        <!DOCKTYPE html>
        <html>
            <head>
